...
<body>
<form id="form04" name="form04" action="CalculatorFemale02" method="post"> 
	...
	<div>
		<label for="pull_up">仰卧起坐<br/>(单位：个):</label>
		<input name="sit_ups" id="sit_ups" type="text">
	</div>
	<div>
	...
	<div>
		<label for="run_1000">800米跑<br/>(单位：s):</label>
		<input name="run_800" id="run_800" type="text">
	</div>
	<div class="bot">
