...
public class CalculatorFemale01 extends HttpServlet {



	private static final long serialVersionUID = 1L;
	public CalculatorFemale01() {
		super();
...
out.close();	
	...
	int grade=0;
	i_vital_capacity=i_vital_capacity+50;
	...
	int grade=0;
	if (i_seat_flexion>=25.8) {
		grade=100;
	}else if (i_seat_flexion<25.8&&i_seat_flexion>=24.0) {
		grade =95;
	}else if (i_seat_flexion<24.09&&i_seat_flexion>=22.2) {
		grade =90;
	}else if (i_seat_flexion<22.2&&i_seat_flexion>=20.6) {
		grade =85;
	}else if (i_seat_flexion<20.6&&i_seat_flexion>=19.0) {
		grade =80;
	}else if (i_seat_flexion<19.0&&i_seat_flexion>=17.7) {
		grade =78;
	}else if (i_seat_flexion<17.7&&i_seat_flexion>=16.4) {
		grade =76;
	}else if (i_seat_flexion<16.4&&i_seat_flexion>=15.1) {
		grade =74;
	}else if (i_seat_flexion<15.1&&i_seat_flexion>=13.8) {
		grade =72;
	}else if (i_seat_flexion<13.8&&i_seat_flexion>=12.5) {
		grade =70;
	}else if (i_seat_flexion<12.5&&i_seat_flexion>=11.2) {
		grade =68;
	}else if (i_seat_flexion<11.2&&i_seat_flexion>=9.9) {
		grade =66;
	}else if (i_seat_flexion<9.9&&i_seat_flexion>=8.6) {
		grade =64;
	}else if (i_seat_flexion<8.6&&i_seat_flexion>=7.3) {
		grade =62;
	}else if (i_seat_flexion<7.3&&i_seat_flexion>=6.0) {
		grade =60;
	}else if (i_seat_flexion<6.0&&i_seat_flexion>=5.2) {
		grade =50;
	}else if (i_seat_flexion<5.2&&i_seat_flexion>=4.4) {
		grade =40;
	}else if (i_seat_flexion<4.4&&i_seat_flexion>=3.6) {
		grade =30;
	}else if (i_seat_flexion<3.6&&i_seat_flexion>=2.8) {
		grade =20;
	}else if (i_seat_flexion<2.8&&i_seat_flexion>=2.0) {
		grade =10;
	}
	else {
		grade =0;
 ...
 */
	private int  i_standing_long_jumpGrade(int i_standing_long_jump) {
		int grade=0;
		i_standing_long_jump=i_standing_long_jump+1;
	...
	private int sit_upsGrade(int i_sit_ups) {
		...
		if (i_sit_ups==57) {
			...
			grade =80;
		}else if (i_sit_ups<47&&i_sit_ups>=45) {
			grade =78;
